	...
	<div class="container">
		...
		<div class="productos-total">
			...
			<div class="productos-g">
					<a href="#"><img class="foto-moto" src="images/moto1.jpeg" alt="moto"></a>
				<div class="caja-articulo">
					<h2 class="texto-articulo"><a class="links" href="#">Victory Hammer SUPERLOW</a></h2>
					<a class="ic-flecha" href="#"><img class="flecha" src="images/ic-flecha.png" alt="flecha icono"></a>
				</div>
			</div>

			<div class="productos-g">
					<a href="#"><img class="foto-moto" src="images/moto2.jpeg" alt="moto"></a>
				<div class="caja-articulo">
			...
			<div class="productos-g">
					<a href="#"><img class="foto-moto" src="images/moto3.jpeg" alt="moto"></a>
				<div class="caja-articulo">
			...
			<div class="productos-g">
					<a href="#"><img class="foto-moto" src="images/moto4.jpeg" alt="moto"></a>
				<div class="caja-articulo">
